        ...
        <div className="bg-white shadow-md rounded-xl p-8 max-w-md w-full">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                type="email"
                className="mt-1 w-full px-4 border border-gray-300 rounded-md
                shadow-sm focus:outline-none focus:ring-2 fouc:ring-[black]"
            ...
            <button
              type="submit"
              className="w-full bg-[black] hover:bg-[#4b4b4b] text-white py-2
              px-4 rounded-md font-medium cursor-pointer"
              disabled={loading}
              onClick={handleStep1}
            >
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                ...
                focus:otuline-none focus:ring-2 focus:ring-[black]"
            ...
            <button
              type="sumbit"
              className="w-full bg-[black] hover:bg-[#4b4b44b]
